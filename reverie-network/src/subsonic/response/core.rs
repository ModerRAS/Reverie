...
pub enum ResponseData {
    ...
    NewestPodcasts(NewestPodcastsData),
}
...
pub use super::{
    ...
    ArtistsData, BookmarkItem, BookmarksData, CaptionItem, CaptionsData, ChatMessagesData, Child,
    DirectoryData, DirectoryItem, GenreItem, GenresData, IndexesData, InternetRadioStationItem,
    InternetRadioStationsData, JukeboxStatusData, LicenseData, LyricsData, LyricsListData,
    MusicFolderItem, MusicFoldersData, NewestPodcastsData, NowPlayingData,
    OpenSubsonicExtensionItem, OpenSubsonicExtensionsData, PlayQueueData, PlaylistData,
    PlaylistItem, PlaylistWithEntries, PlaylistsData, PodcastsData, RandomSongsData,
    ScanStatusData, SearchResult2Data, SearchResult3Data, ShareItem, SharesData, SimilarSongs2Data,
